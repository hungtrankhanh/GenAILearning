...
export default async function askChatbot(req, res) {
  ...
  try {
    ...
    console.log("responseMessage.function_call = " + JSON.stringify(response, null, 2))
    if (responseMessage.function_call) {
      ...
      console.log("messages before filter = " + JSON.stringify(messages, null, 2))
      ...
      console.log("messages after filter = " + JSON.stringify(filtered_messages, null, 2))
